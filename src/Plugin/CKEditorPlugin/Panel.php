 ...
 * )
 */
class Panel extends CKEditorPluginBase implements CKEditorPluginContextualInterface, ContainerFactoryPluginInterface {
  ...
  public function getFile() {
    $mentionspathfilename = drupal_get_path('module', 'mentions') . '/js/plugins/panel/plugin.js';
